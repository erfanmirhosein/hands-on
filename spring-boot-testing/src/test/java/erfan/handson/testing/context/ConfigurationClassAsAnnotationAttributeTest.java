...
@SpringBootTest(classes = ConfigurationWithAtConfiguration.class)
class ConfigurationClassAsAnnotationAttributeTest {
    @Autowired
    ...
    void testBeanCreation() {
        ...
        assertThatExceptionOfType(NoSuchBeanDefinitionException.class)
                .isThrownBy(() -> applicationContext.getBean(NestedClass.class));
